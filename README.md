...
- users can get their top queries as a suggestion when the page load
- users can get suggestions based on the query they typed
...
``git clone `https://github.com/yodit93/Helpjuice-search-front-end.git`
...
> I would like to thank Hotjuice team.
